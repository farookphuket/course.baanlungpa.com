    ...
    <div>
        ...
        v-for="bl in blog.data"
            ...
            <p class="title">
                ...
                <span class="tag is-warning rounded has-text-danger" 
                    v-if="isOwner === bl.user_id && bl.bl_is_public !== 1">
            ...
            <!-- show slug,create date,user End -->
            <!-- show excerpt START -->
            <div class="content">
            ...
            <div class="mb-4 mt-2 pb-6" 
                ...
                <div class="field is-pulled-right">
                    <span class="tag is-large is-warning is-light has-text-danger 
                        has-text-weight-bold mb-4 pb-4" 
                        v-if="isOwner === bl.user_id 
                        && bl.bl_is_public !== 1">Private</span>
