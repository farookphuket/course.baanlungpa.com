...
@section('content')
   ...
   <div style="background-color:#e7e7e7;">
        <div style="background-color:white;color:blue;padding:2px;">
            ...
            <p> {{$title}} from {{$website}}</p>
            <p>
                this maybe cause by the lost of password please click (or copy 
                and paste the address below into your browser's address bar).
            </p>
            <p>
                <a href="{{$reset_link}}" target="_blank">Click here</a> 
                to open link in 
